...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-^!s7u_m99v(222dg2gh)pw=f!qc$166x6de8mkn5nynvglw529')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'store.context_processors.cart_items_count',  # Custom context processor for badge
            ],
        },
    },
]
